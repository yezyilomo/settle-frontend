    ...
    return (
        <div class="prop-overview row p-0 m-0">
            ...
            <div class="prop-info col-12 px-1">
                <div class="prop-type">Available for <span class="bg-primary text-light">{props.property.available_for}</span></div>
...
function PropertySliderOverview(props) {
    ...
    return (
        <div class="prop-slider-overview row p-0 m-0">
            ...
            <div class="prop-info col-12 px-1">
                <div class="prop-type">
                    Available for <span class="bg-primary text-light">{props.property.available_for}</span>
                </div>
                <div class="prop-price">
                    {props.property.currency} {props.property.price} / Month
                </div>
